...
import { setChat, initiateRedirect, cancelRedirect, setPostedBooks } from "../Actions";
...
class SelectedBookPage extends Component {
    ...
    editChange = () => {
        axios
            .put(`http://localhost:3500/api/book/${this.props.book.id}`, { description: this.state.description })
            .then(res => {
                axios
